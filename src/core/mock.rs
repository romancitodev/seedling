...
use crate::core::traits::{Schema, Table};
...
// Backend implementations will be added here incrementally
#[cfg(feature = "rusqlite")]
impl<T: Table<S>, S: Schema, const N: usize> crate::backend::RusqliteExecutor for Mock<T, S, N> {
